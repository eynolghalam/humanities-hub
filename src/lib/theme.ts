...
const themes: Record<ThemeName, ThemeColors> = {
  light: {
    ...
    foreground: 'oklch(0.24 0.045 164)',
    surface: 'oklch(1 0 0)',
    card: 'oklch(1 0 0)',
    cardForeground: 'oklch(0.24 0.045 164)',
    primary: 'oklch(0.38 0.08 164)',
    primaryForeground: 'oklch(0.985 0.006 160)',
    primaryGlow: 'oklch(0.64 0.06 164)',
    secondary: 'oklch(0.95 0.015 164)',
    secondaryForeground: 'oklch(0.28 0.05 164)',
    accent: 'oklch(0.68 0.08 86)',
    accentForeground: 'oklch(0.24 0.045 164)',
    muted: 'oklch(0.95 0.012 164)',
    mutedForeground: 'oklch(0.5 0.025 164)',
    destructive: 'oklch(0.58 0.22 27)',
    destructiveForeground: 'oklch(0.985 0 0)',
    border: 'oklch(0.9 0.018 164)',
  },
  dark: {
