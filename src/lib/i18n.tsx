...
const dict = {
  ...
  en: {
    ...
    libraryButton: "Grade Library",
    libraryDialogTitle: "Grade Books Library",
    libraryUrl: "Library URL",
    libraryUrlHelp: "ghbook page URL (e.g. https://www.ghbook.ir/read/fa-IR/796)",
  ...
  ar: {
    ...
    libraryButton: "مكتبة المرحلة",
    libraryDialogTitle: "كتب المرحلة",
    libraryUrl: "رابط المكتبة",
    libraryUrlHelp: "رابط صفحة ghbook (مثل: https://www.ghbook.ir/read/fa-IR/796)",
